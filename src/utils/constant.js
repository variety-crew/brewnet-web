...
export const SEARCH_CRITERIA = {
  ...
  RETURN_STOCK_DEPT_RETURN_MANAGER: 'returningManager',
};
// 입고 확인 페이지 criteria
...
export const CRITERIA_RETURN_STOCK_DEPT_LIST = [
  ...
  SEARCH_CRITERIA.RETURN_STOCK_DEPT_RETURN_MANAGER,
];
...
// 타부서 처리건의 본사의 재고조정 처리 상태
export const RETURN_STOCK_CHECK_STATUS = {
  CONFIRMED: 'CONFIRMED',
  UNCONFIRMED: 'UNCONFIRMED',
};
